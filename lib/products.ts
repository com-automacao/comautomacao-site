...
export const products: Product[] = [
  ...
  },
  {
    ...
    tagline: "Sua presença digital, com a cara da sua marca.",
    lead: "Sites, landing pages e portais sob medida — rápidos, responsivos e prontos para converter. A presença da sua empresa na internet, feita do jeito certo.",
    short: "Sites e landing pages sob medida para a sua marca.",
    audience: ["Empresas sem site", "Negócios locais", "Profissionais liberais", "Lojas indo pro digital"],
    problem: {
      title: "Um site fraco afasta cliente.",
      body: "Página lenta, que não abre direito no celular e não aparece no Google. Quem procura a sua empresa não encontra — ou encontra e desiste.",
      bullets: [
    ...
    solution: {
      title: "Um site rápido, bonito e que converte.",
      body: "Projeto sob medida para a sua marca: design próprio, performance, responsivo de verdade e otimizado para busca. Pronto para gerar contato.",
      bullets: [
        "Design sob medida para a marca",
        "Rápido e 100% responsivo",
        "Otimizado para SEO e conversão",
      ],
    },
    features: [
      { icon: "sparkles", title: "Design sob medida", body: "Layout exclusivo, alinhado à identidade da sua empresa — nada de tema genérico." },
      { icon: "bolt", title: "Performance", body: "Carregamento rápido e fluido, do desktop ao celular." },
      { icon: "users", title: "Responsivo de verdade", body: "Experiência impecável em qualquer tela e tamanho." },
      { icon: "chart", title: "SEO & conversão", body: "Estrutura otimizada para aparecer no Google e gerar contato." },
      { icon: "link", title: "Integrações", body: "WhatsApp, formulários, analytics e o que mais a operação pedir." },
      { icon: "shield", title: "Manutenção", body: "Acompanhamento e ajustes para o site evoluir com você." },
    ],
    steps: [

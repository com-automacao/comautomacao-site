...
export const products: Product[] = [
  ...
  },
  {
    ...
    acquirers: [
      { src: "/products/pdv-mais/acquirers/1.webp", name: "Clover" },
      { src: "/products/pdv-mais/acquirers/2.webp", name: "Getnet Smart" },
      {
        src: "/products/pdv-mais/acquirers/3.webp",
        name: "PagBank Moderninha Smart 2",
      },
      { src: "/products/pdv-mais/acquirers/4.webp", name: "PicPay Smart" },
      { src: "/products/pdv-mais/acquirers/5.webp", name: "Rede Laranjinha Smart" },
      { src: "/products/pdv-mais/acquirers/6.webp", name: "SafraPay Smart" },
      { src: "/products/pdv-mais/acquirers/7.webp", name: "Sicredi Smart" },
      { src: "/products/pdv-mais/acquirers/8.webp", name: "Stone Smart" },
      { src: "/products/pdv-mais/acquirers/9.webp", name: "BIN/Fiserv Smart" },
      { src: "/products/pdv-mais/acquirers/10.webp", name: "Cielo LIO" },
    ],
    problem: {
